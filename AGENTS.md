...
- **🚨 CRITICAL: NEVER BYPASS ARGOCD 🚨** - All changes must go through Git/PRs, be merged to latest `master`, and pushed; never apply direct manual changes that bypass ArgoCD.
